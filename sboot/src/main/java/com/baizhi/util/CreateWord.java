...
import com.baizhi.service.Impl.PullUpScoreServiceImpl;
...
public class CreateWord {
    ...
    public Map createWord(List<SourceOutPdfVo> listVo, String uuid, String threadName, String index) {
        ...
        for (SourceOutPdfVo vo : listVo) {
            j++;
            if (j % 2 == 0) {
                System.out.println("执行第" + j + "个" + threadName + "index=" + index);
            }
            ...
            outPDFNameIndex++;
            //
            System.out.println("线程" + threadName + "执行生成word");
